macro(register_qx_component)
    ...
    # Copy header documentation template with modifcations
    message(STATUS "TEST: ${FILE_TEMPLATES_PATH}/primary_component_header.dox.in")
    message(STATUS "TEST: ${DOC_GENERATED_PATH}/${COMPONENT_NAME_LC}.dox")
    configure_file(
        "${FILE_TEMPLATES_PATH}/primary_component_header.h.dox.in"
        "${DOC_GENERATED_PATH}/${COMPONENT_NAME_LC}.h.dox"
        @ONLY
        NEWLINE_STYLE UNIX
    )
