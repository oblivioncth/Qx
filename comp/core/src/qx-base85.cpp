...
Base85ParseError Base85::parseExternalString(const QString& base85, Base85& externallyEncoded)
{
...
Base85 Base85::fromEncodedString(const QString& base85, const Base85Encoding* enc, Base85ParseError* error)
{
    ...
    // Parse
    Base85ParseError parseError = parseExternalString(base85, externallyEncoded);
